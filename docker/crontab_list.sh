...
# 取关京东店铺商品
20 23 * * * node /scripts/jd_unsubscribe.js >> /scripts/logs/jd_unsubscribe.log 2>&1
# 清空购物车
55 7,11,18,22 * * * node /scripts/jd_cleancart.js >> /scripts/jd_cleancart.log 2>&1
# 京东试用
0 1 * * * node /scripts/jd_try.js >> /scripts/logs/jd_try.js 2>&1
# 京豆变动通知
...
#天天加速
0 0-23/3 * * * node /scripts/jd_speed.js >> /scripts/logs/jd_speed.log 2>&1
#京东健康兑换商品
...
#京东店铺签到
0 0,9,18,23 * * * node /scripts/jd_jiulan_platypus_shop_sign.js >> /scripts/logs/jd_jiulan_platypus_shop_sign.log 2>&1
...
#赚30元
0 6 * * * node /scripts/jd_earn30.js >> /scripts/logs/jd_earn30.log 2>&1
#汪汪乐园每日任务
