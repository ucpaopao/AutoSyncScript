...
[task_local]
#15减5
59 6,9,14,17,20 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_car_exchange.js, tag=15减5, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_redPacket.png, enabled=true

================Loon==============
[Script]
cron "59 6,9,14,17,20 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_car_exchange.js, tag=15减5

===============Surge=================
15减5 = type=cron,cronexp="59 6,9,14,17,20 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_car_exchange.js

============小火箭=========
15减5 = type=cron,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_car_exchange.js, cronexpr="59 6,9,14,17,20 * * *", timeout=3600, enable=true
 */
const $ = new Env('15减5');
