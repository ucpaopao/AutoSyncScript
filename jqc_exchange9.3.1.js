...
[task_local]
#抢9减3
59 7,9,11,13,15 * * * https://gitee.com/lxk0301/jd_scripts/raw/master/jd_car_exchange.js, tag=抢9减3, img-url=https://raw.githubusercontent.com/58xinian/icon/master/jd_redPacket.png, enabled=true

================Loon==============
[Script]
cron "59 7,9,11,13,15 * * *" script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_car_exchange.js, tag=抢9减3

===============Surge=================
抢9减3 = type=cron,cronexp=59 7,9,11,13,15 * * *",wake-system=1,timeout=3600,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_car_exchange.js

============小火箭=========
抢9减3 = type=cron,script-path=https://gitee.com/lxk0301/jd_scripts/raw/master/jd_car_exchange.js, cronexpr="59 7,9,11,13,15 * * *", timeout=3600, enable=true
 */
const $ = new Env('抢9减3');
