...
function zqdkck() {
   if ($request.url.indexOf("addNote?") > -1) {
    $.setdata($request.url,'zqdkurl')
    $.log(zqdkurl)
$.setdata(JSON.stringify($request.headers),'zqdkhd')
$.log(zqdkhd)
    $.setdata($request.body,'zqdkbody')
$.log(zqdkbody)
...
//user_id=zqdkurl.match(/user_id=(\d+)/)[1]
